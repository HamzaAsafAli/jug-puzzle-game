...
public class Jug {
	...
	/**
	 * Construct a Jug with the specified integers 0<=amount<=capacity. If
	 * invalid capacity or amount are presented, a Jug with amount=capacity=0 is
	 * created.
	 * 
	 * @param capacity
	...
	/**
	 * Set the capacity of this to c if possible, otherwise this is unchanged.
	 * 
	 * @param c
	...
	/**
	 * Fill this from other Jug, either emptying other or filling this. Spilling
	 * this into this leaves this unchanged.
	 * 
	 * @param other
